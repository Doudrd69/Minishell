...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   check_syntax_append.c                              :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: wmonacho <wmonacho@student.42lyon.fr>      +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/11/12 19:34:54 by wmonacho          #+#    #+#             */
/*   Updated: 2022/11/12 19:34:54 by wmonacho         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
static int	check_syntax_jgl(t_shell *minishell, char *str, int i)
{
	int	j;
...
int	check_syntax_append(t_shell *minishell, char *str, int i)
{
	...
	j = ft_strlen(str);
	if (check_syntax_jgl(minishell, str, i) == 0)
		return (0);
	if (j >= i + 2)
	{
	...
	if (j >= i + 1)
		if (check_syntax_end(minishell, str, i) == 0)
			return (0);
	if (check_syntax_after_append(minishell, str, i) == 0)
		return (0);
	return (1);
}
